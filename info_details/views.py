...
from .serializers import AboutSerializer,ProjectSerializer,SkillSerializer,WorkSerializer,EducationSerializer,CompanySerializer,PdfSerializer
from .models import About,Project,Skill,Work,Education,Company_User,test
...
class PdfView(ListCreateAPIView):
